...
ln -s $CONFIG_DIR/alacritty ~/.config/alacritty && echo "symlink alacritty"
ln -s $CONFIG_DIR/picom ~/.config/picom && echo "symlink picom"
ln -s $CONFIG_DIR/dunst ~/.config/dunst && echo "symlink dunst"